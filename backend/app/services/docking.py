...
class DockingService:
    @staticmethod
    def submit_job(user_id: int, protein_name: str, ligand_name: str, capabilities: list = None, partner_ligand_name: str = None) -> str:
        db = SessionLocal()
        try:
            ...
            threading.Thread(
                ...
                args=(job_id, protein_name, ligand_name, capabilities, partner_ligand_name),
                daemon=True
            ).start()
